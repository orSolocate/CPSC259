...
void process_file(double array_to_populate[], FILE * pointer_to_data_file)
{
	...
	while (fgets(line_buffer, LINESIZE, pointer_to_data_file)) {
		...
		values_per_line = sscanf_s(line_buffer, "%d %d %d %d %d %d", extracted_values, extracted_values+1, extracted_values+2, extracted_values+3, extracted_values+4, extracted_values+5);
